...
#include <VortexWidgets/vminislider.h>
...
using Vortex::VMiniSlider;

VMiniSlider::VMiniSlider(double limit, QWidget* parent) :
	m_limit{ limit },
	QWidget(parent)
{
	//init_attributes();
...
void VMiniSlider::set_limit(double limit)
{
	m_limit = limit;
...
LAttribute* VMiniSlider::value()
{
	return m_value;
}

// void VMiniSlider::init_attributes()
// {
// 	m_value->on_change(
// 		[this] {
// 			update_handle_pos();
...
void VMiniSlider::update_handle_pos()
{
	// TODO: NEED TO FIX
	// m_handle->move(
...
bool VMiniSlider::eventFilter(QObject* object, QEvent* event)
{
...
double VMiniSlider::drag_increment() const
{
	// TODO: NEED TO FIX
	// int bar_margins =
	// 	m_bar->margins_left()->as<double>() +
