...
// using Vortex::VComboBoxItemDelegate;

// VComboBoxItemDelegate::VComboBoxItemDelegate(QObject* parent) :
...
// QPainterPath VComboBoxItemDelegate::background_path(
...
// LAttribute* VComboBoxItemDelegate::corner_radius() const
// {
// 	return m_corner_radius;
// }

// LAttribute* VComboBoxItemDelegate::fill() const
// {
// 	return m_fill;
// }

// void VComboBoxItemDelegate::paint(
// 	QPainter* painter,
// 	const QStyleOptionViewItem& option,
// 	const QModelIndex& index) const
// {
...
// void VComboBoxItemDelegate::set_is_above_control(bool condition)
// {
// 	m_is_above_control = condition;
// }

// LAttribute* VComboBoxItemDelegate::text_color() const
// {
// 	return m_text_color;
// }
