...
VButton* VMainWindowTitlebar::settings_button() const
{
	return m_settings_button;
}

VButton* VMainWindowTitlebar::minimize_button() const
{
	return m_minimize_button;
}

VButton* VMainWindowTitlebar::maximize_button() const
{
	return m_maximize_button;
}

VButton* VMainWindowTitlebar::exit_button() const
{
