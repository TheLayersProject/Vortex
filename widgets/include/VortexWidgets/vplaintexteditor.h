...
#ifndef VPLAINTEXTEDITOR_H
#define VPLAINTEXTEDITOR_H
...
class VORTEX_WIDGETS_EXPORT VPlainTextEditor : public QPlainTextEdit
{
	Q_OBJECT

public:
	VPlainTextEditor(QWidget* parent = nullptr);
